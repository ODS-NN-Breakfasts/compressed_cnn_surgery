"""
Resnet18 training script in PyTorch modified from https://gist.github.com/y0ast/d91d09565462125a1eb75acc65da1469
DNN compression is based on the NNCF package: https://github.com/openvinotoolkit/nncf
"""
...
def train(model, train_loader, optimizer, epoch, compression_ctrl):
    model.train()
